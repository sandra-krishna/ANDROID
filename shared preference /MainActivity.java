...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstNameEditText = findViewById(R.id.ED1);
        lastNameEditText = findViewById(R.id.ED2);
        emailEditText = findViewById(R.id.ED3);
        phoneEditText = findViewById(R.id.ED4);
        passwordEditText = findViewById(R.id.ED5);
        dobEditText = findViewById(R.id.ED6);
